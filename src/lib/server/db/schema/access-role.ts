...
export const accessRole = pgTable('access_role', {
	...
	navPharmacy: boolean('nav_pharmacy').notNull().default(true),
	navTools: boolean('nav_tools').notNull().default(true),
	navSettings: boolean('nav_settings').notNull().default(false),
	navCommunity: boolean('nav_community').notNull().default(false),
	...
	pharmacyReadAll: boolean('pharmacy_read_all').notNull().default(false),
	pharmacyWrite: boolean('pharmacy_write').notNull().default(false),
