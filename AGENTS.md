...
- **Language**: TypeScript
- **Package Manager**: npm (`npm …` / `npm run …`)
...
| Rule                                                           | Scope                                         |
| -------------------------------------------------------------- | --------------------------------------------- |
| [`project-stack.mdc`](.cursor/rules/project-stack.mdc)         | Always on — stack, npm scripts                |
...
| `employee-portal-npm`               | Package install, npm scripts                           |
...
8. **Validate** — svelte-autofixer, `npm run lint`, `npm run check`
